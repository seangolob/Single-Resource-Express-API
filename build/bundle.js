...
var PokemonForm = React.createClass({displayName: "PokemonForm",
  ...
  render: function() {
    return (
      React.createElement("form", {onSubmit: this.handleSubmit}, 
        React.createElement("label", {htmlFor: "newpokemonname"}, "Pokemon Name"), 
        React.createElement("input", {id: "newpokemonname", type: "text", value: this.state.newPokemon.pokemonName, onChange: this.handleChange}), 
        React.createElement("button", {type: "submit"}, "Create New Pokemon")
      )
    )
  }
});
...
var Pokemon = React.createClass({displayName: "Pokemon",
  render: function() {
    return React.createElement("li", null, this.props.data.pokemonName)
  }
});
...
var PokemonList = React.createClass({displayName: "PokemonList",
  render: function() {
    var pokemons = this.props.data.map(function(pokemon) {
      return React.createElement(Pokemon, {data: pokemon, key: pokemon._id})
    });
    return (
      React.createElement("section", null, 
        React.createElement("h1", null, "Pokemon:"), 
...
var PokemonApp = React.createClass({displayName: "PokemonApp",
  getInitialState: function() {
    return {pokemonData: []};
  },
  ...
  render: function() {
    return (
      React.createElement("main", null, 
        React.createElement(PokemonForm, {onNewPokemonSubmit: this.onNewPokemon, url: this.props.pokemonBaseUrl}), 
        React.createElement(PokemonList, {data: this.state.pokemonData})
      )
    )
  }
});

React.render(React.createElement(PokemonApp, {pokemonBaseUrl: '/api/v1/pokemon'}), document.body);
